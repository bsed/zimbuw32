/*
 * Generated from Zimbu file copy.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Ts YvfVa(Yw8L *t, Ti Abyte); /* MIOModule__CFile.writeByte */
...
Ti YfIs(); /* MIOModule.readByte */
Ts YZFc(Ti Abyte); /* MIOModule.writeByte */
...
Tc *Yw8L__Yw8L_I_imt[] = {
 ...
 (Tc*)YvfVa, /* MIOModule__CFile.writeByte - YvfVa */
